                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(image: NetworkImage(img), fit: BoxFit.cover),borderRadius: BorderRadius.circular(20)
                          ),
                        ),
                      ],
                    ),
                    Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Text(
                            title,
                            maxLines: 2,style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),textAlign: TextAlign.center,
                          ),
                        ),
                        SizedBox(
                          height: 50,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  Text('Anul '),
                                  Text('$years',style: TextStyle(fontSize: 18,letterSpacing: 10),),
                                ],
                              ),
                              Column(
                                children: [
